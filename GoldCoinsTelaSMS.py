...
"font-weight: bold;")
        ...
        self.BotaoVoltar = QtWidgets.QPushButton(self.container_3, clicked = lambda: self.GoBack())
        self.BotaoVoltar.setGeometry(QtCore.QRect(190, 580, 101, 51))
...
"background-repeat: norepeat;")
        ...
        self.BotaoProsseguir = QtWidgets.QPushButton(self.container_3, clicked = lambda: self.OpenConfirmation())
        self.BotaoProsseguir.setGeometry(QtCore.QRect(640, 580, 141, 51))
...
"")
        ...
        self.radioButton_2.setGeometry(QtCore.QRect(60, 460, 231, 20))
...
"")
    ...
    def retranslateUi(self, TelaSMS):
        ...
        self.label_9.setText(_translate("TelaSMS", "Com que frequência deseja receber os SMS?"))
