...
"color: rgb(251, 190, 119);")
        ...
        self.SignInButton = QtWidgets.QPushButton(self.container_2, clicked = lambda: self.OpenRegistrationWindow())
...
"")
    ...
    def retranslateUi(self, TelaVitoria):
        ...
        self.SignInButton.setText(_translate("TelaVitoria", "Cadastre-se"))
#import images_rc
